    ...
    >
      <View style={styles.goalHeader}>
        <View style={styles.goalTitleRow}>
          <View
            style={[styles.goalDot, { backgroundColor: goal.color }]}
          />
          <Text
          ...
          {editing ? (
            <View style={styles.editRow}>
              ...
              <Pressable onPress={handleSaveProgress}>
                <Text style={[styles.saveText, { color: goal.color }]}>
                  SAVE
                </Text>
              </Pressable>
            </View>
            ...
            <Pressable onPress={() => setEditing(true)}>
              <Text
                style={[
                  styles.goalCurrent,
                  { color: goal.color, fontFamily: MONO },
                ]}
              >
                {goal.unit === "$"
      ...
      <View style={styles.goalFooter}>
        ...
        <Text
          style={[styles.goalRemaining, { color: colors.mutedForeground }]}
        >
